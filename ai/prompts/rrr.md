# Create a detailed session retrospective
...
2. **Create Retrospective and LEARNING.md File**:
   Check if the repo has a directory `ai/retro`. If missing then create it.
   Create file at `ai/retro/YYYY-MM/DD/HH.MM_retro.md`
   (e.g., `ai/retro/2025-12/06/11.30_retro.md`)
...
3. **Update `ai/LEARNING.md`**
Summarize lesson learned from this session and update to the `ai/LEARNING.md` for future reference (bottom only). If the learning is similar or related to the existing learning then you can update the existing ones. If no new learning then you can leave it untouched.

**IMPORTANT**: Just add a short summary because this file will be read every time and it will keep growing.
